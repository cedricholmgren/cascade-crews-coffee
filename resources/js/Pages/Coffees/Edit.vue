...
const form = useForm({
    _method: "PUT",
    order_id: lastUserCoffee.order_id,
    user_id: lastUserCoffee.user_id,
    name: lastUserCoffee.name,
    size: lastUserCoffee.size,
    note: lastUserCoffee.note,
});

// Function to submit coffee
const submitCoffee = () => {
    form.put(route("coffees.update", lastUserCoffee.id));
};
</script>
